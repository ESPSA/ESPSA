<?php
require_once 'dp.php';
$compStmt = $mysqli->prepare('SELECT id, name, description, event_date, details_page, image_url FROM competitions WHERE archived = FALSE');
$compStmt->execute();
...
<head>
    ...
    <title>ESPSA - Competitions</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link active" href="competition.php">Competition</a></li>
...
<main class="container my-5 pt-5">
    <h1 class="mb-4 section-title">Competitions</h1>
    <div class="row">
        <?php while ($c = $competitions->fetch_assoc()): ?>
        <div class="col-md-4 mb-4">
            <div class="card">
                <div class="event-gallery">
                    <img src="<?php echo e($c['image_url']); ?>" alt="competition image">
                </div>
                <div class="card-body">
                    <h5 class="card-title"><?php echo e($c['name']); ?></h5>
                    <p class="card-text"><?php echo e($c['description']); ?></p>
                    <p><i class="fas fa-calendar-alt"></i> Date: <?php echo e($c['event_date']); ?></p>
                    <?php if ($c['details_page']): ?>
                    <a href="<?php echo e($c['details_page']); ?>" class="btn btn-primary">Details</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
